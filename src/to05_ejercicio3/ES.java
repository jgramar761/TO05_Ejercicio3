 ...
 * También incluye un par de métodos para simpliciar la escritura de mensajes en pantalla, abreviando la escritura de las sentencias
 * System.out.println() y System.out.print(). Se hace uso también de la sobrecarga de métodos, que es algo que se había visto con 
 * los constructores, pero sin entrar en detalle. Así, podemos tener tres métodos para lee enteros, que se llaman todos igual, pero
...
public class ES {
    ...
    /**
     * Este método sirve para leer desde teclado cualquier número double en el
     * rango de números del tipo double. La lectura se estará repitiendo hasta que
     * el valor suministrado esté en ese rango.
     *
    ...
    public static double leeDouble() {
        ...
        do {
            try {
                ...
                ES.msgln("Error: No es un número Double válido.");
            }
     ...
     * Este método sirve para escribir el mensaje indicado para solicitar la
     * introducción de un dato desde teclado, y espera la introducción de
     * cualquier número double y una String que mostrará
     * dato leído. La lectura se estará repitiendo hasta que el valor
     * suministrado esté en ese rango.
     *
     * @param mensaje Es el mensaje que se muestra para solicitar la
     ...
     *
     * @param minimo Es el valor más pequeño dentro del rango de los números
     * tipo double que se aceptará como válido.
     * @return El número double leído.
     */
    public static double leeDouble(double minimo) {
        double numero = 0;
        boolean leido = false;
        Scanner teclado = null;
        do {
            try {
                ...
                if (numero >= minimo) {
                    ...
                    ES.msgln("Error: Debe ser un número double mayor o igual que " + minimo + ". ");
                }
            } catch (Exception e) {
                ES.msgln("Error: No es un número double válido.");
            }
     ...
     * Este método sirve para escribir el mensaje indicado para solicitar la
     * introducción de un dato desde teclado, y espera la introducción de
     * cualquier número double en el rango de números que además
     * sea mayor o igual que el valor mínimo indicado como parámetro. La lectura
     * se estará repitiendo hasta que el valor suministrado esté en ese rango.
     *
     * @param mensaje  Es el mensaje que se muestra para solicitar la
     * introducción del número.
     * @param minimo  Es el valor más pequeño dentro del rango de los números
     * double que se aceptará como válido.
     * @return El número double leído.
     */
    public static double leeDouble(String mensaje, double minimo) {
        ...
        do {
            ...
            try {
                ...
                ES.msgln("Error: No es un número Double válido. Recuerde");
            }
    ...
    /**
     * Este método sirve para leer desde teclado cualquier número double en el
     * rango de números que además sea mayor o igual que el valor
     * mínimo indicado como primer parámetro y menor o igual que el valor máximo
     * indicado como segundo parámetro. La lectura se estará repitiendo hasta
     * que el valor suministrado esté en ese rango.
     *
     ...
     *   es mayor que el mínimo.
     */
    public static double leeDouble(double minimo, double maximo) throws IllegalArgumentException {
        double numero = 0;
        boolean leido = false;
        Scanner teclado = null;
            ...
            do {
                try {
                    ...
                    if (numero >= minimo && numero <= maximo) {
                        ...
                        ES.msgln("Error: Debe ser un número Double mayor o igual que " + minimo + " y menor o igual que " + maximo + ". ");
                    }
                } catch (Exception e) {
                    ES.msgln("Error: No es un número Double válido. Recuerde usar , ");
                }
            } while (!leido);
        } else {
            throw new IllegalArgumentException("Rango imposible. El valor mínimo no puede ser mayor que el valor máximo");
     ...
     * mostrando por pantalla la pregunta en cuestión. Solo se admiten como
     * respuestas
     *
     * @param mensaje  Es el mensaje que se envía con la pregunta cuya
     * respuesta se espera que sea Si o No.
